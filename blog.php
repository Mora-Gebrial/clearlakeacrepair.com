...
$blog->my['siteurl'] = 'https://www.clearlakeacrepair.com/';
$blog->my['blogtitle'] = 'Blog - Air Conditioner Sugar Land TX';
...
<html lang="en">
<head>
<base href="https://www.clearlakeacrepair.com/" />
    <meta charset="UTF-8">
...
$blog->head(); ?>
    ...
    <meta name="copyright" content="Air Conditioner Sugar Land TX"/>
    <meta name="classification" content="Air Duct"/>
    <link rel="apple-touch-icon" href="images/apple-touch-icon.webp">
  
    <link rel="stylesheet" type="text/css" href="print.css" media="print"/>
    <meta property="og:title" content="Blog - Air Conditioner Sugar Land TX" />
    ...
    <meta property="og:url" content="https://www.clearlakeacrepair.com/" />
    <meta property="og:image" content="https://www.clearlakeacrepair.com/images/favicon.webp" />
    <meta property="og:site_name" content="Air Conditioner Sugar Land TX">

    <script type="application/ld+json">
      {
          "@context": "http://schema.org",
          "@type": "LocalBusiness",
          "name": "Air Conditioner Sugar Land TX",
          "image": "https://clearlakeacrepair.com/images/logo.webp",
          "url": "https://clearlakeacrepair.com/",
          "telephone": "713-489-5104",
          "email": "service@clearlakeacrepair.com",
          "description": "Overhead Door Sugar Land, TX offers professional garage door installation, repair, and replacement. Top brands, 24-hour service, and affordable prices",
          "address": {
              "@type": "PostalAddress",
...
<body>
    ...
    <header>
      ...
      <nav class="navbar navbar-expand-lg bg-body-tertiary">
          <div class="container">
            <a class="navbar-brand" href="#"><img src="images/logo.webp" alt="logo" title="Air Conditioner Sugar Land TX" class="logo"></a>
            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
              <ul class="navbar-nav m-auto mb-2 mb-lg-0 ">
                <li class="nav-item">
                  <a class="nav-link active" aria-current="page" href="https://clearlakeacrepair.com/">HOME</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="dryer-vent.html">DRYER VENT</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="air-duct.html">AIR DUCT</a>
                </li>
  ...
  <div class="row">
    ...
    <div class="col-lg-6">
      <div class="header-img" >
        <img src="images/ac-repair-header.webp" alt="ac-repair-header"  title="Air Conditioner Sugar Land TX"   class="header-img img-fluid" data-aos="zoom-in-left">
        <div class="header-txt" data-aos="fade-right">
          <h1>Air Conditioner <br> Sugar Land TX</h1>
          ...
          <a href="tel:7134895104" class="call"><button>713-489-5104</button></a>
        </div>
      </div>
    </div>
    <div class="col-lg-3"></div>
...
<div class="footer">
  <div class="container">
      <div class="row">
          <div class="col-lg-6">
              <h4>Air Conditioner Sugar Land TX</h4>
              <p>You can reach us fastest by calling: <br>
                (713) 489-5104
                  </p>
                  <p>16618 Southwest Fwy, Sugar Land, TX 77478</p>
      ...
      <p>© All rights reserved. www.clearlakeacrepair.com</p>
  </div>
          </div>
